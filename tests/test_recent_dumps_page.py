import pytest
from wdumper_scraper import RecentDumpsPage, ScraperError, PageError
...
def test_extract_last_id_raises_page_error_on_missing_table(make_scraper):
...
def test_extract_last_id_raises_page_error_on_missing_link(make_scraper):
...
def test_extract_last_id_raises_page_error_on_missing_href(make_scraper):
...
def test_extract_last_id_raises_page_error_on_non_integer_id(make_scraper):
...
def test_init_raises_scraper_error_on_bad_status(make_scraper):
